...
double T_atRegionBoundary(double p, const char *boundary) {
  ...
  double n3ab[] = {0.0,
                   ...
                   -0.191887498864292e4,
                   0.918419702359447e3};
  double n3cd[] = {0.0, 0.585276966696349e3, 0.278233532206915e1,
  ...
  double n3mn[] = {0.0, 0.535339483742384e3, 0.761978122720128e1,
                   -0.158365725441648, 0.192871054508108e-2};
  double n3op[] = {0.0,
                   0.969461372400213e3,
                   -0.332500170441278e3,
                   0.642859598466067e2,
                   0.773845935768222e3,
                   -0.152313732937084e4};
  double n3qu[] = {0.0, 0.565603648239126e3, 0.529062258221222e1,
                   -0.102020639611016, 0.122240301070145e-2};
  double n3rx[] = {0.0, 0.584561202520006e3, -0.102961025163669e1,
                   0.243293362700452, -0.294905044740799e-2};
  double n3uv[] = {0.0, 0.528199646263062e3, 0.890579602135307e1,
                   -0.222814134903755, 0.286791682263697e-2};
  double n3wx[] = {0.0,
                   0.728052609145380e1,
                   0.973505869861952e2,
                   0.147370491183191e2,
