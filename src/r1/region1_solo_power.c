...
void solo_ij_pow_reg1(double vi,double vj,double *soI_pow,double *soJ_pow)
{
    ...
    soI_pow[6] = soI_pow[5] * soI_pow[3]; //8
    soI_pow[7] = soI_pow[6] * soI_pow[6] * soI_pow[5]; //21
    soI_pow[8] = soI_pow[7] * soI_pow[2]; //23
    
    soI_pow[9] = soI_pow[6] * soI_pow[7]; //29
    soI_pow[10] = soI_pow[9] * vi; //30
    soI_pow[11] = soI_pow[10] * vi; //31
    soI_pow[12] = soI_pow[11] * vi; //32
  
    //  -2, -1, 0, 1, 2, 3, 4, 5, -9, -7, -3, 17, -4, 6, -5, 10, -8, -11, -6, -29, -31, -38, -39, -40, -41,
    double vj_inv = 1.0 / vj; 
    double vj2=vj*vj;
    soJ_pow[0] = vj_inv*vj_inv; //-2
    soJ_pow[1] = vj_inv;  //-1
    soJ_pow[2] = 1.0; // 0
    soJ_pow[3] = vj;  // 1
    soJ_pow[4] = vj2; //2
    ...
    soJ_pow[9] = soJ_pow[8] * vj2; // -7
    soJ_pow[10] =soJ_pow[0] *vj_inv; // -3

    soJ_pow[11] = J_pow7 * J_pow10; // 17
    soJ_pow[12] = soJ_pow[10]*vj_inv; // -4
    soJ_pow[13] = soJ_pow[7] * vj; //6
    soJ_pow[14] = soJ_pow[12] *vj_inv; //-5
    soJ_pow[15] = J_pow10; // 10

    soJ_pow[16] =soJ_pow[10]* soJ_pow[14]; //-8
    soJ_pow[17] = soJ_pow[16] * soJ_pow[10]; //-11
    soJ_pow[18] = soJ_pow[14]*vj_inv; //-6
    soJ_pow[19] = vj_inv*soJ_pow[8] * soJ_pow[16] * soJ_pow[17]; // -29
    soJ_pow[20] = soJ_pow[19] * soJ_pow[0]; //-31

    soJ_pow[21] = soJ_pow[20] * soJ_pow[9]; //-38
    soJ_pow[22]= vj_inv *soJ_pow[21]; // -39
    soJ_pow[23]= vj_inv *soJ_pow[22]; // -40
    soJ_pow[24]= vj_inv *soJ_pow[23]; // -41
