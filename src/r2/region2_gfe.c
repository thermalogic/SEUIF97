...
{
    return poly_solo(pi, tau - 0.5, 43, IJn, i2soI, j2soJ, solo_ij_pow_reg2);
}

double gammar_pi_reg2(double pi, double tau)
{
    return poly_solo_i(pi, tau - 0.5, 43, IJn, i2soI, j2soJ, solo_ij_pow_reg2);
}

double gammar_pipi_reg2(double pi, double tau)
{
    return poly_solo_ii(pi, tau - 0.5, 43, IJn, i2soI, j2soJ, solo_ij_pow_reg2);
}

double gammar_pitau_reg2(double pi, double tau)
{
    return poly_solo_ij(pi, tau - 0.5, 43, IJn, i2soI, j2soJ, solo_ij_pow_reg2);
}

double gammar_tau_reg2(double pi, double tau)
{
    return poly_solo_j(pi, tau - 0.5, 43, IJn, i2soI, j2soJ, solo_ij_pow_reg2);
}

double gammar_tautau_reg2(double pi, double tau)
{
    return poly_solo_jj(pi, tau - 0.5, 43, IJn, i2soI, j2soJ, solo_ij_pow_reg2);
}
...
{
    polys_solo_0_i(pi, tau - 0.5, 43, IJn, i2soI, j2soJ, solo_ij_pow_reg2, poly, poly_pi);
}

void polys_solo_i_j_reg2(double pi, double tau, double *poly_pi, double *poly_tau)
{
    polys_solo_i_j(pi, tau - 0.5, 43, IJn, i2soI, j2soJ, solo_ij_pow_reg2, poly_pi, poly_tau);
}

void polys_solo_0_j_reg2(double pi, double tau, double *poly, double *poly_tau)
{
    polys_solo_0_j(pi, tau - 0.5, 43, IJn, i2soI, j2soJ, solo_ij_pow_reg2, poly, poly_tau);
}

void polys_solo_i_ij_reg2(double pi, double tau, double *poly_pi, double *poly_pitau)
{
    polys_solo_i_ij(pi, tau - 0.5, 43, IJn, i2soI, j2soJ, solo_ij_pow_reg2, poly_pi, poly_pitau);
}

void polys_solo_i_ii_reg2(double pi, double tau, double *poly_pi, double *poly_pipi)
{
    polys_solo_i_ii(pi, tau - 0.5, 43, IJn, i2soI, j2soJ, solo_ij_pow_reg2, poly_pi, poly_pipi);
}

void polys_solo_i_ij_jj_reg2(double pi, double tau, double *poly_pi, double *poly_pitau, double *poly_tautau)
{
    polys_solo_i_ij_jj(pi, tau - 0.5, 43, IJn, i2soI, j2soJ, solo_ij_pow_reg2, poly_pi, poly_pitau, poly_tautau);
}

void polys_solo_i_ii_ij_reg2(double pi, double tau, double *poly_pi, double *poly_pipi, double *poly_pitau)
{
    polys_solo_i_ii_ij(pi, tau - 0.5, 43, IJn, i2soI, j2soJ, solo_ij_pow_reg2, poly_pi, poly_pipi, poly_pitau);
}
...
{
    polys_solo_i_ii_ij_jj(pi, tau - 0.5, 43, IJn, i2soI, j2soJ, solo_ij_pow_reg2, poly_pi, poly_pipi, poly_pitau, poly_tautau);
}