...
**Note:** A new **Rust version** offers a major upgrade with **2-3× speedup**, **36 properties** (vs 30), and multi-ecosystem package support. See [RustSEUIF97](https://github.com/thermalogic/RustSEUIF97).
